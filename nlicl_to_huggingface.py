"""
Convert pild checkpoints to Huggingface style.
"""
...
def main():
    ...
    parser.add_argument("--path", type=str, help="Path of pild checkpoint folder")
    args = parser.parse_args()

    print("pild checkpoint -> Huggingface checkpoint for {}".format(args.path))

    state_dict = torch.load(os.path.join(args.path, "pytorch_model.bin"))
    new_state_dict = {}
